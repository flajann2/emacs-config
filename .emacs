...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-flyspell all-the-icons-nerd-fonts
                  auto-save-buffers-enhanced bm
                  bracketed-paste buffer-move cff
                  clang-format cmake-mode company-ghci
                  dune dune-format elixir-mode ellama
                  elm-mode flycheck-ocaml flymake-hlint
                  ...
                  org-superstar origami powerline
                  purescript-mode smartparens sublimity
                  toc-org treemacs-evil treesit-auto
                  ts-comint typescript-mode utop
                  vertico-posframe window-layout
                  workgroups2 yafolding yasnippet))
